    ...
    <>
          ...
          {TeamSection.map(member => (
            <div className="box" key={member.id}>
              ...
              <div className="social-icons">
                <a href="https://www.facebook.com/share/1D4gD24L1b/" className="icon"><img src="social-icon-img/facebook-f.svg" alt="" /></a>
                <a href="https://www.linkedin.com/in/saurabh-singh-a1a26a3a5/" className="icon"><img src="social-icon-img/twitter.svg" alt="" /></a>
                <a href="https://www.instagram.com/saurabh._chaudhary18?igsh=dnAxMmhvZWJ1Y2Q0" className="icon"><img src="social-icon-img/instagram.svg" alt="" /></a>
      ...
      {/* <div id="contact-service">
        ...
        <div className="box" id="box-3">
            ...
            <h3>Email US</h3>
            <h4>saurabh.singh_cs23@gla.ac.in</h4>
        </div>
    </div> */}
    </>
